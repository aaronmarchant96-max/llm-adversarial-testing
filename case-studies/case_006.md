...
1. Whether the model can preserve a strict output schema.
2. Whether the model can apply a simple trusted policy correctly.
3. Whether untrusted retrieved context changes the decision direction.
