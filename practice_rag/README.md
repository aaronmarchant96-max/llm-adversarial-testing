...
**Researcher:** [Aaron Marchant](https://github.com/aaronmarchant96-max) ([PromptHound](https://twitter.com/PromptHound96))
**Environment:** Tuxedo OS   Beelink Mini PC | CPU-only | ~8 GB RAM | Ollama | Python 3.10
**Status:** Active (April 2026)

[![GitHub last commit](https://img.shields.io/badge/last%20commit-April%202026-brightgreen)](https://github.com/aaronmarchant96-max/llm-adversarial-testing)
